...
setup(
  name = 'unousb',         # How you named your package folder (MyLib)
  packages = ['unousb'],   # Chose the same as "name"
  version = __version__,      # Start with a small number and increase it with every change you make
  license='gpl-3.0',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  description = 'Library for unorick usb interface',   # Give a short description about your library
  author = 'Akanksha Wadhwa',                   # Type in your name
  author_email = 'wadhwaakanksha7@gmail.com',      # Type in your E-Mail
  ...
  keywords = ['ultrasound', 'usb', 'unorick'],   # Keywords that define your package best
